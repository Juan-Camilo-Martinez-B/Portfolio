...
const AboutMe: React.FC<AboutMeProps> = ({ onOpenModal }) => {
  ...
  return (
    <section className="w-full h-full flex flex-col justify-center items-center space-y-8 p-4">
        <figure className="w-56 h-56 md:w-80 md:h-80 border-4 border-blue-500 dark:border-orange-500 rounded-full bg-gray-300 dark:bg-gray-700 flex items-center justify-center mb-4 transition-colors duration-300 overflow-hidden relative shadow-glow">
        ...
        <article className="w-full max-w-4xl flex flex-col md:flex-row items-start justify-between gap-8 md:gap-12">
          <div className="text-center md:text-left md:w-1/3 w-full">
            <hr className="hidden md:block w-full h-px bg-blue-500 dark:bg-orange-500 mb-4 border-0" />
        ...
        <hr className="w-full max-w-2xl h-px bg-blue-500 dark:bg-orange-500 border-0" />
